...
class FriendsMemoryApp { 
    ...
    loadData() { 
        ...
        this.friends = [
            {
                name: "Adithiya",
                quote: "The creative genius who fills our hearts with artistic wonder 🎨💖",
                description: "Always bringing fresh perspectives and creative magic to everything we do!",
                avatar: "heart-avatar-adithiya.jpg",
                heartColor: "#FF6B6B"
            },
            {
                name: "Pranav",
                quote: "The tech wizard who connects all our hearts digitally 💻🌹",
                description: "Making our group chats legendary and keeping us all connected with his tech skills!",
                avatar: "heart-avatar-pranav.jpg",
                heartColor: "#FF69B4"
            },
            {
                name: "Gokul",
                quote: "The sports enthusiast who keeps our hearts racing with excitement 🏸💕",
                description: "Always up for an adventure and gets everyone motivated to stay active!",
                avatar: "heart-avatar-gokul.jpg",
                heartColor: "#FFB6C1"
            },
            {
                name: "Vasi",
                quote: "The thoughtful soul who brings wisdom to our hearts 🤔❤️",
                description: "The one we all turn to for advice and deep, meaningful conversations!",
                avatar: "heart-avatar-vasi.jpg",
                heartColor: "#DC143C"
            },
            {
                name: "Shobika",
                quote: "The cheerful spirit who lights up our hearts with joy 😊💖",
                description: "Her infectious smile and positive energy makes every gathering brighter!",
                avatar: "heart-avatar-shobika.jpg",
                heartColor: "#FF1493"
            },
            {
                name: "Bhavasri",
                quote: "The caring friend with the most compassionate heart 🤗🌹",
                description: "Always there with a kind word and warm support when anyone needs it most!",
                avatar: "heart-avatar-bhavasri.jpg",
                heartColor: "#CD5C5C"
            },
            {
                name: "Jyotsna",
                quote: "The brilliant mind who illuminates our hearts with knowledge ✨💕",
                description: "Her intelligence and curiosity inspire us all to learn and grow together!",
                avatar: "heart-avatar-jyotsna.jpg",
                heartColor: "#FF69B4"
            },
            {
                name: "Rahul",
                quote: "The heart of our group who brings us all together 👑❤️",
                description: "The wonderful soul who created this beautiful space for all our memories!",
    ...
    renderGallery() { 
        ...
        this.galleryImages.forEach((image, index) => { 
            ...
            galleryItem.onclick = () => this.openLightbox(image); 
    ...
    renderFriends() { 
        ...
        this.friends.forEach((friend, index) => { 
            ...
            friendCard.style.animationDelay = `${index * 0.2}s`; 

            friendCard.innerHTML = `
                <div class="friend-avatar" style="background: linear-gradient(135deg, ${friend.heartColor}, #FFD700)">
                    💖
                </div>
        ...
        for (let i = 0; i < 8; i++) { 
            setTimeout(() => { 
                ...
                heart.animate([ 
                    ...
                    { transform: `translate(${Math.cos(angle * Math.PI/180) * distance}px, ${Math.sin(angle * Math.PI/180) * distance}px) scale(1.2)`, opacity: 0 } 
                ], { 
